  ...
  <div class="row historyList" :style="style">
    <div class="col-sm-12">
      <div class="alert alert-default" v-if="!histories.length">
        When you press the "Add to history" button in the preview, the current diagram (puml and svg) will be saved in
        this history
        until you close your session. This allows you to snapshot different versions and go back if you want to.
      </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-8 text-right">
              <ul class="list-inline">
                ...
                <li>
                  <a :href="createUrl(history.encodedText, 'svg')" target="_blank">svg <i
