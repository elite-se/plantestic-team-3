...
class M2MTransformerTest : StringSpec({
    ...
    "[Puml->ReqRes] Transform parameter_pass example" {
        MetaModelSetup.doSetup()

        val pumlInputModel = ResourceSetImpl().getResource(URI.createFileURI(PARAMETER_PASS_INPUT_PATH), true).contents[0]
    ...
    "[ReqRes->RestAssured] Transform parameter_pass example" {
        MetaModelSetup.doSetup()

        val reqresInputModel =
            ResourceSetImpl().getResource(URI.createFileURI(PARAMETER_PASS_REQRES_INPUT_PATH), true).contents[0]
    ...
    companion object {
        ...
        private val PARAMETER_PASS_INPUT_PATH = Resources.getResource("parameter_pass_puml.xmi").path
        ...
        private val PARAMETER_PASS_REQRES_INPUT_PATH = Resources.getResource("parameter_pass_reqres.xmi").path
